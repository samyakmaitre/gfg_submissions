...
class Solution {
    ...
    // Helper function to check if an array forms a palindrome
    ...
    // Helper function to check if a column forms a palindrome
    private boolean isColumnPalindrome(int[][] arr, int col) {
        int start = 0;
        int end = arr.length - 1;
        while (start < end) {
